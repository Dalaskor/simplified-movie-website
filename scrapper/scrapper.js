...
const parseFilm = async (page) => {
    try {
        const film = await page.evaluate(() => {
            ...
            const name_en = document.querySelector(
                '[data-tid="eb6be89"]'
            ).innerText;
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                switch (title) {
                    case TITLES.year:
                        year = row.querySelector(
                            '[href^="/lists/movies/year"]'
                        ).innerText;
                        break;
                    case TITLES.country:
                        country = Array.from(
                            row.querySelectorAll(
                                '[href^="/lists/movies/country"]'
                            ),
                            (el) => el.innerText
                        );
                        break;
                    case TITLES.genre:
                        genre = Array.from(
                            row.querySelectorAll(
                                '[href^="/lists/movies/genre"]'
                            ),
                            (el) => el.innerText
                        );
                        break;
                    case TITLES.tagline:
                        const checkTagline = row.querySelector(
                    ...
                    case TITLES.budget:
                        budget =
                            row.querySelector('[href^="/film/"]').innerHTML;
                        break;
                    case TITLES.feesUS:
                        feesUS =
                            row.querySelector('[href^="/film/"]').innerHTML;
                    ...
                    case TITLES.premiereRU:
                        premiereRU = row.querySelector(
                            '[href^="/premiere/"]'
                        ).innerText;
                        break;
                    case TITLES.premiere:
                        premiere =
                            row.querySelector('[href^="/film/"]').innerText;
                        break;
                    ...
                    case TITLES.releaseBluRay:
                        ...
                        break;
                    case TITLES.age:
                        age = row.querySelector(
                            '[data-tid="5c1ffa33"]'
                        ).innerText;
                        break;
                    case TITLES.ratingMPAA:
                        ratingMPAA = row.querySelector(
                            '[data-tid="5c1ffa33"]'
                        ).innerText;
                        break;
                    case TITLES.time:
                        time = row.querySelector(
                            '[data-tid="e1e37c21"]>div'
                        ).innerText;
                        break;
                }
